...
//                listCurrentView.clear();
    ...
    public void createLayoutQuestion(String TypeQuestion){
      ...
      //          Toast.makeText(getApplicationContext(),"in createlayout radio "+listQuest.get(nbQues).getQuestion(),Toast.LENGTH_LONG).show();
                ArrayList<EditText> currentRadio=new ArrayList<EditText>();
                ...
                imAdd.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT));
                viewQuest.addView(imAdd);
