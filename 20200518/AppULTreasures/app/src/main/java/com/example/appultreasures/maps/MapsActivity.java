...
// popUp
                ...
                if(L_Marker_Confimed.contains(marker.getPosition())){
                    ...
                    Toast.makeText(getApplicationContext(),"index="+INDEX+"   CLICK SUR "+D_check.key_value_DataSubmit(),Toast.LENGTH_LONG).show();
        ...
        if(requestCode==2 && data!=null){ // result from Windo_popUp_Admin_check ( Confirme || Delete)
            ...
            if(extra!=null) {
                ...
                if(extra.getBoolean("Submit_bool")) {
                    // krmel bas terja3 mn l popUp  t3ml refresh
                    finish();

                    Intent create= new Intent(getApplicationContext(),MapsActivity.class);
