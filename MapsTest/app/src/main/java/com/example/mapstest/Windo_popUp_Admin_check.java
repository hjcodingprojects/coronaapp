    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BsubmitDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DataSubmit.Insert_Point_ADMIN(Dpop_up.getLatitude(),Dpop_up.getLongitude(),Dpop_up.getFull_Name(),Dpop_up.getNb_family(),CheckHosp,sp_transf.getText().toString(),CheckHome);
